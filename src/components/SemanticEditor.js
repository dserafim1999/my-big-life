...
const TimeSpan = (props) => {
  ...
  return (
    <span onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} onClick={() => (console.log(Entity.get(props.entityKey).getData()))} className='tag is-info clickable'>{props.children}</span>
  )
}
